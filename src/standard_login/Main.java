...
package standard_login;

import Component.CoverPanel;
...
public class Main extends javax.swing.JFrame {
    ...
    private int cover = 40;
    private int coverint = 50;
    ...
    public Main() {
        ...
        bg.setLayout(layout);
        coverPanel.addActionlisten(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                System.out.println(".actionPerformed()");
            }
        });
        bg.add(coverPanel, "width " +cover+ "%, pos 0al 0 n 100%");
